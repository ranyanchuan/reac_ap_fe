...
rm(path.resolve(__dirname, './build'), err => {
  ...
  cpr(path.resolve(__dirname, './ucf-publish/wbalone/index/index.html'), path.resolve(__dirname, './build/' + packageName + '/index.html'), {}, err => {
    cpr(path.resolve(__dirname, './ucf-publish/wbalone/index/index.css.gz'), path.resolve(__dirname, './build/' + packageName + '/index/index.css.gz'), {}, err => {
      cpr(path.resolve(__dirname, './ucf-publish/wbalone/index/index.css'), path.resolve(__dirname, './build/' + packageName + '/index/index.css'), {}, err => {
        cpr(path.resolve(__dirname, './ucf-publish/wbalone/index/index.js.gz'), path.resolve(__dirname, './build/' + packageName + '/index/index.js.gz'), {}, err => {
