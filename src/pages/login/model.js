...
export default {
    ...
    initialState: {
        langCode: getCookie('u_locale') || 'zh-CN', // 当前语种
        langList: [],// 多语列表
        username: '', // 用户名
        password: '', //密码
        errMsg: '', // 错误信息
        ...
        async loginAjax(loginData,getState) {
            ...
            if (res.status === "0") {
                ...
                if (message.status == "50012") {
                    ...
                    // u.confirmDialog({
                    //     msg: message.msg,
                    //       title: $.i18n.prop('js.pag.log.0005'),
                    //     onOk: function () {
                    //         viewModel.modifyDefaultpw();
                    //         $('#editTitle').text(message.msg);
                    //     },
                    //     onCancel: function () {
                    //         var parms = JSON.parse(parm);
                    //         parms.pwdExpiredCancle = true;
                    //         viewModel.ajaxfuns.loginAjax(JSON.stringify(parms));
                    //     }
                    // });
                }
