...
class App extends Component {
    ...
    render() {
        let {langCode,langList,verfiyImg,errMsg,codeVerfiy,checked,username,password,forgetpswErrMsg,forgetpswVerfiyImg,forgetstep,forgetpsw,step2MsgType,step2Phone,step1User,step2Wait} = this.props; 
            ...
            <div className="login-main">
                <div className="login-top">
                    <div className="login-logo">
                        <div className="logo-img"><img src=""/></div>                                          
                    </div>
                ...
                <div className="login-content">
                    ...
                    <div className="content-center"><img src={require(`static/images/login-center_${langCode}.png`)}/></div>    
                ...
                <Modal visible={forgetpsw}  step={forgetstep} className={langCode === 'en_US'? 'modal-en': ''}>
                    ...
                    <div className="login-tabs step3">
                        ...
                        <Modal.Content className="reset-psw">
                            ...
                            <div className="psw-p">
                                ...
                                <div className="psw-p-input">
                                    <div>
                                        <input className="u-form-control text"  id="newpsd" ref="newpsd" type="password"/>
                                    </div>
                                </div>
                            </div>
                            <div className="psw-p">
                                ...
                                <div className="psw-p-input">
                                    <div>
                                        <input className="u-form-control text"  id="confirmnewpsd" ref="confirmnewpsd" type="password"/>
                                    </div>
                                </div>
                            </div>
                            <div className="psw-error-msg" id="psw-error-msg">{forgetpswErrMsg}</div>   
                    ...
                    <div className="login-tabs step4">
                        ...
                        {/* <Modal.Foot>
                            <Button className="modalOK" onClick={this.closeForgetPsw}>{getMultiLang("00018","关闭")}</Button>
                        </Modal.Foot> */}
                    </div>
